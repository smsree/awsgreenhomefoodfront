...
const AdminLoginForm = props =>{
    ...
    return <AdminModal onClose={props.onCloseAdmin}>
        ...
        {isLoginCorrect   &&<button onClick={addMealsHandler} className={classes.buttonAdmin}>Add Items</button>}
        {isLoginCorrect && <button className={classes.buttonAdmin} onClick={removeMealsHandler} >Remove Items</button>}
